...
const { searchKeys } = require("./ItemSchema");
...
exports.add = async (req, res) => {
  try {
    ...
    //------------------create data-------------------
    let dataCreated = await itemService.createNewData({ ...req.body });
...
exports.update = async (req, res) => {
  try {
    ...
    if (!datafound) {
      throw new ApiError(httpStatus.OK, `Item not found.`);
    }

    let dataUpdated = await itemService.getOneAndUpdate(
      {
        _id: idToBeSearch,
        isDeleted: false,
      },
...
exports.allFilterPagination = async (req, res) => {
  try {
    ...
    //-----------------------------------
    let dataFound = await itemService.aggregateQuery(finalAggregateQuery);
    ...
    let result = await itemService.aggregateQuery(finalAggregateQuery);
...
exports.get = async (req, res) => {
  try {
    ...
    let dataExist = await itemService.findAllWithQuery(matchQuery);
...
exports.getById = async (req, res) => {
  try {
    ...
    let dataExist = await itemService.getOneByMultiField({
      _id: idToBeSearch,
      isDeleted: false,
    });
...
exports.statusChange = async (req, res) => {
  try {
    let _id = req.params.id;
    let dataExist = await itemService.getOneByMultiField({ _id });
    if (!dataExist) {
      throw new ApiError(httpStatus.OK, "Data not found.");
    }
    let isActive = dataExist.isActive ? false : true;

    let statusChanged = await itemService.getOneAndUpdate(
      { _id },
      { isActive }
    );
    if (!statusChanged) {
