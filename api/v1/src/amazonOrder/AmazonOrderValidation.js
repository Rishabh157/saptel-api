...
const create = {
  body: Joi.object().keys({
    amazonOrderId: Joi.string().required(),
    purchaseDate: Joi.string().lowercase().required(),
    ...
    label: Joi.string().lowercase().required(),
  }),
};
...
const update = {
  ...
  body: Joi.object().keys({
    amazonOrderId: Joi.string().lowercase().required(),
    purchaseDate: Joi.string().lowercase().required(),
    productName: Joi.string().required(),
    quantity: Joi.number().required(),
    itemPrice: Joi.number().required(),
...
const get = {
  query: Joi.object()
    .keys({
      ...
      amazonOrderId: Joi.string().optional(),
    })
    .optional(),
};
