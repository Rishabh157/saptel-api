...
const assetLocationService = require("../assetLocation/AssetLocationService");
const { searchKeys } = require("./AllocationSchema");
...
exports.update = async (req, res) => {
  try {
    ...
    //------------------Find data-------------------
    let datafound = await allocationService.getOneByMultiField({
      _id: idToBeSearch,
    });
    if (!datafound) {
...
exports.allFilterPagination = async (req, res) => {
  try {
    ...
    let objectIdFileds = ["assetLocationId", "companyId"];
    ...
    let userRoleData = await getUserRoleData(req, allocationService);
    let fieldsToDisplay = getFieldsToDisplay(
      moduleType.assetAllocation,
      userRoleData,
