...
const asrRequestService = require("./AsrRequestService");
const companyService = require("../company/CompanyService");

const { searchKeys } = require("./AsrRequestSchema");
...
exports.allFilterPagination = async (req, res) => {
  try {
    ...
    let booleanFields = [];
    let numberFileds = [];
    let objectIdFields = ["productId", "companyId"];
    ...
    let userRoleData = await getUserRoleData(req, asrRequestService);
...
exports.getById = async (req, res) => {
  try {
    ...
    let dataExist = await asrRequestService.getOneByMultiField({
      _id: idToBeSearch,
      isDeleted: false,
    });
    let allowedFields = getAllowedField(fieldsToDisplay, dataExist);
