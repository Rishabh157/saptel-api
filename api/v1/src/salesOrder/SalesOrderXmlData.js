  ...
  itemDataForTally?.map((ele) => {
    ...
    <ALLINVENTORYENTRIES.LIST>
      ...
      <RATEDETAILS.LIST>
       ...
       <GSTRATE>  ${ele?.taxPercentForTally[0]?.cgst / 2}</GSTRATE>
      </RATEDETAILS.LIST>
      <RATEDETAILS.LIST>
       <GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD>
       <GSTRATEVALUATIONTYPE>Based on Value</GSTRATEVALUATIONTYPE>
       <GSTRATE>  ${
         ele?.taxPercentForTally[0]?.sgst
           ? ele?.taxPercentForTally[0]?.sgst / 2
           : ele?.taxPercentForTally[0]?.utgst
       }</GSTRATE>
      </RATEDETAILS.LIST>
      <RATEDETAILS.LIST>
       <GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD>
       <GSTRATEVALUATIONTYPE>Based on Value</GSTRATEVALUATIONTYPE>
       <GSTRATE>  ${ele?.taxPercentForTally[0]?.igst}</GSTRATE>
      </RATEDETAILS.LIST>
      <RATEDETAILS.LIST>
