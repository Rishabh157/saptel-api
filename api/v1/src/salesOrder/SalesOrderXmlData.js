 ...
 <IMPORTDATA>
  ...
  <REQUESTDATA>
   <TALLYMESSAGE xmlns:UDF="TallyUDF">
    <VOUCHER REMOTEID="4ccfb29f-4861-4411-95d8-ab91432bea7c-0000665d" VCHKEY="4ccfb29f-4861-4411-95d8-ab91432bea7c-0000b174:00000020" VCHTYPE="Sales Order" ACTION="Create" OBJVIEW="Invoice Voucher View">
     <OLDAUDITENTRYIDS.LIST TYPE="Number">
      <OLDAUDITENTRYIDS>-1</OLDAUDITENTRYIDS>
     </OLDAUDITENTRYIDS.LIST>
      <DATE>${todaysDate}</DATE>
                    <VCHSTATUSDATE>${todaysDate}</VCHSTATUSDATE>
     <GUID>4ccfb29f-4861-4411-95d8-ab91432bea7c-0000665d</GUID>
     ...
     <VOUCHERNUMBER>PI/24-25/${soNumber}</VOUCHERNUMBER>
     <BASICBUYERNAME>${partyName}</BASICBUYERNAME>
     <CMPGSTREGISTRATIONTYPE>Regular</CMPGSTREGISTRATIONTYPE>
     <REFERENCE>PI/24-25/${soNumber}</REFERENCE>
     ...
     <EFFECTIVEDATE>20240517</EFFECTIVEDATE>
     ...
     <ALTERID> 39621</ALTERID>
     <MASTERID> 26205</MASTERID>
     <VOUCHERKEY>195111774322720</VOUCHERKEY>
     <VOUCHERRETAINKEY>137</VOUCHERRETAINKEY>
     <VOUCHERNUMBERSERIES>Default</VOUCHERNUMBERSERIES>
     <UPDATEDDATETIME>20240520145548000</UPDATEDDATETIME>
     ...
     <ALLINVENTORYENTRIES.LIST>
      <STOCKITEMNAME>${itemDataForTally[0]?.itemNameForTally}</STOCKITEMNAME>
      ...
      <GSTITEMSOURCE>${itemDataForTally[0]?.itemNameForTally}</GSTITEMSOURCE>
      ...
      <ISSCRAP>No</ISSCRAP>
      <RATE>${itemDataForTally[0]?.rateForTally}/PCS</RATE>
      <AMOUNT>${
        itemDataForTally[0]?.rateForTally *
        itemDataForTally[0]?.quantityForTally
      }</AMOUNT>
      <ACTUALQTY> ${itemDataForTally[0]?.quantityForTally} PCS</ACTUALQTY>
      <BILLEDQTY> ${itemDataForTally[0]?.quantityForTally} PCS</BILLEDQTY>
     ...
     <LEDGERENTRIES.LIST>
      ...
      <ROUNDTYPE>&#4; Not Applicable</ROUNDTYPE>
       <LEDGERNAME>${taxType} ${taxPercent}%</LEDGERNAME>
      <GSTCLASS>&#4; Not Applicable</GSTCLASS>
      <ISDEEMEDPOSITIVE>No</ISDEEMEDPOSITIVE>
      <LEDGERFROMITEM>No</LEDGERFROMITEM>
      <REMOVEZEROENTRIES>No</REMOVEZEROENTRIES>
