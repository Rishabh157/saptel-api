const { tallyLedgerType } = require("../../helper/enumUtils");

const ledgerXmlData = (data) => {
  let {
    companyState,
    partyName,
    itemName,
  ...
  gstType?.map((ele) => {
    ...
    <RATEOFINVOICETAX.LIST TYPE="Number">
     <RATEOFINVOICETAX> ${gstRate}</RATEOFINVOICETAX>
    </RATEOFINVOICETAX.LIST>
    <APPROPRIATEFOR>&#4; Not Applicable</APPROPRIATEFOR>
    <ROUNDTYPE>&#4; Not Applicable</ROUNDTYPE>
    <LEDGERNAME>${gstType} ${gstRate}%</LEDGERNAME>
    <GSTCLASS>&#4; Not Applicable</GSTCLASS>
    <ISDEEMEDPOSITIVE>${
      ledgerType === tallyLedgerType.cretidNote ? "Yes" : "No"
    }</ISDEEMEDPOSITIVE>
    ...
    <AMOUNT>${ledgerType === tallyLedgerType.cretidNote ? "-" : ""}${
      (amount * gstRate) / 100
    }</AMOUNT>
    <VATEXPAMOUNT>${ledgerType === tallyLedgerType.cretidNote ? "-" : ""}${
      (amount * gstRate) / 100
    }</VATEXPAMOUNT>
  ...
  let totalAmount = amount + (amount * gstRate) / 100;
  let xmlData = `
    <ENVELOPE>
 <HEADER>
  ...
  <IMPORTDATA>
   ...
   <REQUESTDATA>
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <VOUCHER  VCHTYPE="${ledgerType}" ACTION="Create" OBJVIEW="Invoice Voucher View">
      <OLDAUDITENTRYIDS.LIST TYPE="Number">
       <OLDAUDITENTRYIDS>-1</OLDAUDITENTRYIDS>
      </OLDAUDITENTRYIDS.LIST>
      <DATE>${todaysDate}</DATE>
      <VCHSTATUSDATE>${todaysDate}</VCHSTATUSDATE>
      <GUID>4ccfb29f-4861-4411-95d8-ab91432bea7c-00006680</GUID>
      ...
      <GSTREGISTRATION TAXTYPE="GST" TAXREGISTRATION="23AAGCP7384M1ZV">${companyState} Registration</GSTREGISTRATION>
      <CMPGSTIN>23AAGCP7384M1ZV</CMPGSTIN>
      <VOUCHERTYPENAME>${ledgerType}</VOUCHERTYPENAME>
      <PARTYLEDGERNAME>${partyName}</PARTYLEDGERNAME>
      <VOUCHERNUMBER>${
        ledgerType === tallyLedgerType.cretidNote ? "CNY24/" : "DN24/"
      }${ledgerNumber}</VOUCHERNUMBER>
      ...
      <CMPGSTSTATE>${companyState}</CMPGSTSTATE>
      ...
      <VCHSTATUSVOUCHERTYPE>${ledgerType}</VCHSTATUSVOUCHERTYPE>
      <VCHSTATUSTAXUNIT>${companyState} Registration</VCHSTATUSTAXUNIT>
      ...
      <EFFECTIVEDATE>${todaysDate}</EFFECTIVEDATE>
      ...
      <ALTERID> 39687</ALTERID>
      <MASTERID> 26240</MASTERID>
      <VOUCHERKEY>195159018962952</VOUCHERKEY>
      <VOUCHERRETAINKEY>1</VOUCHERRETAINKEY>
      <VOUCHERNUMBERSERIES>Default</VOUCHERNUMBERSERIES>
      <UPDATEDDATETIME>20240530135529000</UPDATEDDATETIME>
      ...
      <ALLINVENTORYENTRIES.LIST>
       ...
       <GSTHSNNAME>71179090</GSTHSNNAME>
       <GSTHSNDESCRIPTION>${itemName}</GSTHSNDESCRIPTION>
       ...
       <ISSCRAP>No</ISSCRAP>
       <AMOUNT>${
         ledgerType === tallyLedgerType.cretidNote ? "-" : ""
       }${amount}</AMOUNT>
       ...
       <RATEDETAILS.LIST>
        ...
        <GSTRATE> ${cgst / 2}</GSTRATE>
       </RATEDETAILS.LIST>
       <RATEDETAILS.LIST>
        <GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD>
        <GSTRATEVALUATIONTYPE>Based on Value</GSTRATEVALUATIONTYPE>
        <GSTRATE>${cgst ? cgst / 2 : utgst}</GSTRATE>
       </RATEDETAILS.LIST>
       <RATEDETAILS.LIST>
      ...
      <LEDGERENTRIES.LIST>
       ...
       <GSTCLASS>&#4; Not Applicable</GSTCLASS>
       <ISDEEMEDPOSITIVE>${
         ledgerType === tallyLedgerType.cretidNote ? "No" : "Yes"
       }</ISDEEMEDPOSITIVE>
       <LEDGERFROMITEM>No</LEDGERFROMITEM>
       <REMOVEZEROENTRIES>No</REMOVEZEROENTRIES>
    ...
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <COMPANY>
      <REMOTECMPINFO.LIST MERGE="Yes">
       ...
       <REMOTECMPSTATE>${companyState}</REMOTECMPSTATE>
      </REMOTECMPINFO.LIST>
     </COMPANY>
    </TALLYMESSAGE>
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
