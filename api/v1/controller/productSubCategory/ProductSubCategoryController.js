...
exports.add = async (req, res) => {
  try {
    ...
    //------------------create data-------------------
    let dataCreated = await productSubCategoryService.createNewData({
      ...req.body
    })
...
exports.update = async (req, res) => {
  try {
    ...
    if (!datafound) {
      throw new ApiError(httpStatus.OK, `ProductSubCategory not found.`)
    }

    let dataUpdated = await productSubCategoryService.getOneAndUpdate(
      {
        _id: idToBeSearch,
        isDeleted: false
      },
...
exports.allFilterPagination = async (req, res) => {
  try {
    ...
    //-----------------------------------
    let dataFound = await productSubCategoryService.aggregateQuery(
      finalAggregateQuery
    )
...
exports.get = async (req, res) => {
  try {
    ...
    let dataExist = await productSubCategoryService.findAllWithQuery(matchQuery)
...
exports.statusChange = async (req, res) => {
  try {
    let _id = req.params.id
    let dataExist = await productSubCategoryService.getOneByMultiField({ _id })
    if (!dataExist) {
      throw new ApiError(httpStatus.OK, 'Data not found.')
    }
    let isActive = dataExist.isActive ? false : true

    let statusChanged = await productSubCategoryService.getOneAndUpdate(
      { _id },
      { isActive }
    )
    if (!statusChanged) {
