...
const userRoleType = Object.freeze({
  ...
  srTeamLeaderOrSrExicutiveMIS: "SR_TEAM_LEADER_OR_SR_EXICUTIVE_MIS",
  teamLeaderOrExicutiveSalesCenter: "TEAM_LEADER_OR_EXICUTIVE_SALES_CENTER",
  srExicutiveSalesCenter: "SR_EXICUTIVE_SALES_CENTER",
  exicutiveTrainee: "EXICUTIVE_TRAINEE",
  avmHr: "HR_AVM",
  amgHrAndStatutoryCompliance: "AMG_HR_AND_STATUTORY_COMPLIANCE",
  asstManagerHr: "ASST_MANAGER_HR",
  srExicutiveHr: "SR_EXICUTIVE_HR",
  exicutiveHr: "EXICUTIVE_HR",
  avmDistribution: "DISTRIBUTION_AVM",
  srManagerDistribution: "SR_MANAGER_DISTRIBUTION",
  managerArea: "MANAGER_AREA",
  srExicutiveArea: "SR_EXICUTIVE_AREA",
  exicutiveArea: "EXICUTIVE_AREA",
  ...
  exicutiveNetwork: "EXICUTIVE_NETWORK",
  exicutiveIT: "EXICUTIVE_IT",
  ...
  exicutiveQualityAnalyst: "EXICUTIVE_QUALITY_ANALYST",
  avpLogistics: "LOGISTICS_AVP",
  managerLogistics: "MANAGER_LOGISTICS",
  amLogistics: "AM_LOGISTICS",
  exicutiveLogistics: "EXICUTIVE_LOGISTICS",
  avpMapping: "MAPPING_AVP",
  managerMIS: "MANAGER_MIS",
  exicutiveMIS: "EXICUTIVE_MIS",
  avpAdmin: "ADMIN_AVP",
  managerAdmin: "MANAGER_ADMIN",
  srExicutiveAdmin: "SR_EXICUTIVE_ADMIN",
  exicutiveAdmin: "EXICUTIVE_ADMIN",
});
