 ...
 */
 const getOneByMultiField = async (matchObj, projectObj) => {
  return AttributesGroup.findOne({ ...matchObj, isDeleted: false }, { ...projectObj })
  }
 ...
 */
 const getByIdAndUpdate = async (id, updateBody) => {
  return AttributesGroup.findByIdAndUpdate({ _id: id }, { ...updateBody }, { new: true })
  }
  //-------------------------------------------
  /**
 * find One and update
 ...
 */
 const findAllWithQuery = async (matchObj, projectObj) => {
  return AttributesGroup.find({ ...matchObj, isDeleted: false }, { ...projectObj })
  }
  //-------------------------------------------
  /**
 * find one and delete
