 ...
 */
 const getOneByMultiField = async (matchObj, projectObj) => {
  return ProductCategory.findOne({ ...matchObj, isDeleted: false }, { ...projectObj })
  }
 ...
 */
 const getByIdAndUpdate = async (id, updateBody) => {
  return ProductCategory.findByIdAndUpdate({ _id: id }, { ...updateBody }, { new: true })
  }
  //-------------------------------------------
  /**
 * find One and update
 ...
 */
 const findAllWithQuery = async (matchObj, projectObj) => {
  return ProductCategory.find({ ...matchObj, isDeleted: false }, { ...projectObj })
  }
  //-------------------------------------------
  /**
 * find one and delete
