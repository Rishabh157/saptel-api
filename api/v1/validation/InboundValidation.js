...
const create = {
  body: Joi.object().keys({
    ...
    tehsil: Joi.string().custom(commonValidation.objectId).required(),
    ...
    agentDistrict: Joi.string().custom(commonValidation.objectId).required(),
    ...
    channel: Joi.string().custom(commonValidation.objectId).required(),
    remark: Joi.string().lowercase().allow(""),
    dispositionLevelOne: Joi.string()
      .custom(commonValidation.objectId)
      .required(),
    dispositionLevelTwo: Joi.string()
      .custom(commonValidation.objectId)
      .required(),
  }),
};
...
const update = {
  ...
  body: Joi.object().keys({
    ...
    inOutBound: Joi.string().allow(""),
    incomingCallerNo: Joi.string().allow(""),
    mobileNo: Joi.string().required().allow(""),
    deliveryCharges: Joi.number(),
    discount: Joi.number(),
    total: Joi.number(),
    country: Joi.string().custom(commonValidation.objectId).required(),
